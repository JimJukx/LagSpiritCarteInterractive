...
async function loadChapters() {
  try {
    // IMPORTANT : URL absolue vers chapters.json dans le plugin
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Clic en dehors de la boîte -> ferme le popup
  ...
  passBtn.addEventListener("click", async () => {
    ...
    try {
      // On récupère l’URL du secret JSON et de la page admin depuis PHP
      const secretUrl =
        (window.lagspiritCarteData &&
          (lagspiritCarteData.adminSecretUrl ||
           (lagspiritCarteData.assetsBaseUrl &&
            lagspiritCarteData.assetsBaseUrl + "admin/admincarte-secret.json"))) ||
        "/wp-content/plugins/lagspirit-carte/assets/admin/admincarte-secret.json";

      const adminPageUrl =
        (window.lagspiritCarteData &&
          (lagspiritCarteData.adminPageUrl || lagspiritCarteData.admin_url)) ||
        "/wp-content/plugins/lagspirit-carte/assets/admin/admincarte.html";
      ...
      if (pwd === real) {
        ...
        window.open(adminPageUrl, "_blank", "noopener");
        popup.style.display = "none";
      } else {
